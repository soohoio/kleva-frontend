export const en = {
  ...
  'myasset.farming.equityValue.addCollateral.kokonut': 'Assets in Position',
  ...
  'almInfoModal.description': `<strong style="color: #8F00FF;">Stake 7,500+ ibKLEVA</strong> to receive KLEVA Membership benefits - Boosted Leveraged Yield Farming!`,
  'almInfoModal2.description': `<strong style="color: #8F00FF;">Stake 7,500+ ibKLEVA</strong> (Membership benefits will be granted automatically once staking condition is met.)`,
  'almInfoModal.ex.title': 'Example : oUSDT + oUSDC Pair',
  'almInfoModal2.ex.title': 'Example : oUSDT + oUSDC Pair',
  'almInfoModal2.ex.merits': "Benefits",
  'almInfoModal2.ex.info': "Each pool has different leverage and liquidation benefits.",
  'almInfoModal2.ex.link': 'Find more',
  'almExplainPanel.title': `<strong style="color: #8F00FF;">Stake 7,500+ ibKLEVA</strong> for higher Leverage and Liquidation Threshold benefit.`,
  'almExplainPanel.detail': 'Find more',
  'membership': 'Membership',
  'membership2': '',
  'condition': 'Condition',
  'membership.applied': "Boosted",
  'membership.applied2': "You are now Boosted!",
  'membership.applied2.description': "Participate in Boosted Leveraged Yield Farming for higher leverage and liquidation benefit!",
  'membership.applied2.desktop.description': "Membership benefits will be granted automatically once staking condition is met.",
  'membership.applied.myasset.desktop.description': "Enjoy Boosted Leveraged Yield Farming, with higher Leverage and lower Liquidation Fee!",
  'membership.ibStaking.description': `<strong style="color: #8F00FF;">Stake 7,500 ibKLEVA</strong> for KLEVA Membership Benefit - Boosted Leveraged Yield Farming.`,
  'membership.farming.description': `<strong style="color: #8F00FF;">Stake 7,500 ibKLEVA</strong> for Boosted Leveraged Yield Farming.`,
  'membership.farming.description.applied': `<strong style="color: #8F00FF;">You are now Boosted!</strong> Participate in Boosted Leveraged Yield Farming for higher yield!`,

  'temp.unavailable': "Unavailable",
  'dontshowtoday': 'Do not show for today.',
  'close': 'Close',
...
export const ko = {
  ...
  'myasset.farming.equityValue.addCollateral.kokonut': '총 운용 자산 (예치 전)',
  ...
  'myasset.farming.repaymentValue': '상환된 자산',
  ...
  'almInfoModal2.ex.title': 'oUSDT+oUSDC 풀 예시',
  'almInfoModal2.ex.merits': "혜택",
  'almInfoModal2.ex.info': "멤버십 혜택은 대상 풀에 따라 레버리지 및 청산 혜택의 차이가 있습니다.",
  'almInfoModal2.ex.link': '자세히 보기',
  ...
  'membership.ibStaking.description': `<strong style="color: #8F00FF;">ibKLEVA를 7,500개 이상 스테이킹</strong>하면 고배율 레버리지 투자가 가능한 KLEVA 멤버십 혜택을 받을 수 있습니다.`,
