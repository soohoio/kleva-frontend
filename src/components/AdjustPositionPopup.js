...
class AdjustPositionPopup extends Component {
        ...
        tap(() => {
          ...
          if (this.bloc.borrowMore$.value) {
            ...
            getOutputTokenAmount$(
              ...
              this.bloc.leverageImpact$.next(priceImpact)
            })
            ...
            openLayeredModal$.next({
              component: (
                <AreYouSureFarming
                  ...
                  proceedButtonTitle={`Borrow More`}
                />
              )
            })
          ...
          openLayeredModal$.next({
            component: (
              <AreYouSureFarming
                ...
                proceedButtonTitle={`Add Collateral`}
                onClick={() => this.bloc.addCollateral()}
              />
            )
          })
  ...
  getDebtTokenKlevaRewardsAPR = (leverage) => {
    ...
    const borrowingDelta = new BigNumber(this.bloc.newDebtValue$.value)
      .div(10 ** borrowingAsset && borrowingAsset.decimals)
      .minus(this.bloc.debtValue$.value)
      .toNumber()
  ...
  render() {
    ...
    const before_safetyBuffer = before_debtRatio 
      ? new BigNumber(this.bloc.liquidationThreshold$.value)
    ...
    const after_safetyBuffer = after_debtRatio 
      ? new BigNumber(this.bloc.liquidationThreshold$.value)
    ...
    // console.log(newBorrowingInterest, 'newBorrowingInterest')
    ...
    return (
      <Modal className="AdjustPositionPopup__modal" title={title}>
        ...
        {/* <div className="AddPositionPopup__aware">
          ...
          <span className="AddPositionPopup__awareMessage">Please make sure you have read the details of Price Impact and Leverage Impact before taking further actions.</span>
        </div> */}
        <Checkbox
