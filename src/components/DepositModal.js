  ...
  renderWKLAYStep = () => {
    ...
    return (
      <>
            ...
            : (
              <button
                ...
                className={cx("DepositModal__wrapButton", {
                  "DepositModal__wrapButton--disabled": isWrapDisabled,
                })}
              >
                Wrap
              </button>
        ...
        <InputWithPercentage
          className={cx("DepositModal__depositInput", {
            "DepositModal__depositInput--upper": true
          })}
          decimalLimit={stakingToken.decimals}
          ...
          {isKLAY 
            ...
            : (
              <>
                ...
                <InputWithPercentage
                className="DepositModal__depositInput DepositModal__depositInput--common"
                  decimalLimit={stakingToken.decimals}
                  value$={this.bloc.depositAmount$}
                  valueLimit={availableBalance}
                  label={stakingToken.title}
