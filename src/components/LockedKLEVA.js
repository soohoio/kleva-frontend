...
import { fetchUnlockAmount$, lockedKlevaAmount$, selectedAddress$ } from '../streams/wallet'
...
class LockedKLEVA extends Component {
  ...
  render() {
    ...
    const isDisabled = lockedKlevaAmount$.value == 0

    return !!selectedAddress$.value && !isDisabled && (
      <div 
