          ...
          ? (
            <>
              ...
              >
                ...
                {/* <img 
                  className={cx("MobileGNB__copyIcon", {
                    "MobileGNB__copyIcon--copied": this.copied$.value,
                  })}
                  src={this.copied$.value 
                      ? "/static/images/exported/icon-copy-done.svg"
                      : "/static/images/exported/icon-copy.svg"
                  }
                /> */}
              </div>
              <p 
